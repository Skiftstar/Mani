...
import xyz.skifty.moonlight.ui.components.TitleBar
...
fun main() = application {
    ...
    Window(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            // TitleBar composes outside JvmApp's own MoonlightTheme{} wrapper, so it needs its
            ...
            MoonlightTheme(fillContainer = false) {
                TitleBar(
