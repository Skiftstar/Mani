...
fun PlaylistSongTable(
    ...
    Column(modifier = modifier) {
        // The header row (column labels) only earns its place when there are actually multiple
        // labeled columns to explain - on Android, with just cover+title+star left, it was
        // reducing to a lone "Title" label over empty space, so it's dropped there entirely
        // rather than kept for one column.
